...
public class NeiModConfigGui extends GuiConfig {

	public NeiModConfigGui(GuiScreen parent) {
	...
	private static String getTitle(GuiScreen parent) {
		...
		return Translator.translateToLocal("config.nei.title").replace("%MODNAME", Constants.NAME);
	}
}
