...
public class Config {
	...
	private static boolean neiOnServer = true;
	...
	public static boolean isDeleteItemsInCheatModeActive() {
		return deleteItemsInCheatModeEnabled && cheatItemsEnabled && neiOnServer;
	}

	public static boolean isNeiOnServer() {
		return neiOnServer;
	}

	public static void setNeiOnServer(boolean neiOnServer) {
		Config.neiOnServer = neiOnServer;
	}
	...
	public static void preInit(@Nonnull FMLPreInitializationEvent event) {
		configFile = new LocalizedConfiguration("config.nei", event.getSuggestedConfigurationFile(), "0.1.0");
